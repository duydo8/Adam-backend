...
public class FileUploadController {
    ...
    private String cloudDinaryName;

    @Value("cloudinary-api")
    private String cloudDinaryApi;

    @Value("cloudinary-secret")
    private String cloudDinarySecret;

	final Cloudinary cloudinary = new Cloudinary(ObjectUtils.asMap(
			"cloud_name", cloudDinaryName,
			"api_key", cloudDinaryApi,
			"api_secret", cloudDinarySecret));
